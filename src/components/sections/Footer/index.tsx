        ...
        >
            <div className="mx-auto max-w-screen-2xl">
                ...
                {(copyrightText || legalLinks.length > 0) && (
                    <div className="sb-footer-bottom border-t flex flex-col sm:flex-row sm:flex-wrap sm:justify-between">
                        {legalLinks.length > 0 && (
                        ...
                        {copyrightText && (
                            <Markdown
                                ...
                                className={classNames('sb-markdown', 'text-sm', 'mb-4', 'mt-4', { 'sm:order-first sm:mr-12': legalLinks.length > 0 })}
